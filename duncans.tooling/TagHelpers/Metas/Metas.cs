// <copyright file="Metas.cs" company="Duncan Saunders">
...
namespace duncans.TagHelpers
{
    ...
    public class MetaTagHelper : TagHelper
    {
        ...
        private const string DefaultXUA = @"IE=edge,chrome=1";
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            {
                this.MetaModel.AppInfo = new duncans.Utility.AssemblyInfo(System.Reflection.Assembly.GetEntryAssembly());
            }
        ...
        private void AppendHtml5Defaults(ref TagHelperOutput output, ref TagBuilder targetTag)
        {
            ...
            //< meta charset = "utf-8" />
            output.Attributes.Add("charset", DefaultCharset); // note this is applied to the output

            //< meta http-equiv = "X-UA-Compatible" content = "IE=edge" />
            tmpTag = this.CreateSelfClosingMeta();
            tmpTag.Attributes.Add("http-equiv", "X-UA-Compatible");
            tmpTag.Attributes.Add("content", DefaultXUA);
            ...
            tmpTag.Attributes.Add("content", "text/html; charset=" + DefaultCharset.ToUpper());
            targetTag.InnerHtml.AppendHtml(tmpTag);
        }

        private void AppendAppInfo(ref TagBuilder targetTag, duncans.Utility.AssemblyInfo assemblyInfo)
        {
        ...
        private void AppendRobots(ref TagBuilder targetTag)
        {
            ...
            tmpTag.Attributes.Add("name", "robots");
            tmpTag.Attributes.Add("content", robots);
