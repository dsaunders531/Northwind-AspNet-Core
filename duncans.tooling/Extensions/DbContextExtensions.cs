// <copyright file="DbContextExtensions.cs" company="Duncan Saunders">
...
namespace duncans
{
    public static class DbContextExtensions
    {
        ...
        /// <returns></returns>
        public static DbClient.DbClient GetAdvancedClient(this DbContext context)
        {
            DbClient.DbClient result = default(DbClient.DbClient);
