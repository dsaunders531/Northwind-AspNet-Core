// <copyright file="OtherPropertyMustBeValueWhenThisIsValue.cs" company="Duncan Saunders">
...
namespace duncans.shared.Attributes
{
    ...
    public class OtherPropertyMustBeValueWhenThisIsValue : ValidationAttribute, IModelValidator
    {
