// <copyright file="GenericApiController.cs" company="Duncan Saunders">
...
namespace duncans.MVC
{
    ...
    {
        public GenericApiController(IGenericService<TDbModel, TApiRowModel, TDbModelKey> workerService)
        {
            this.WorkerService = workerService;
        }

        private IGenericService<TDbModel, TApiRowModel, TDbModelKey> WorkerService { get; set; }
