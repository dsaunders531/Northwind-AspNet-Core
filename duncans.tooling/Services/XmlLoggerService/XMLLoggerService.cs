// <copyright file="XMLLoggerService.cs" company="Duncan Saunders">
...
namespace duncans.Services.Logging
{
    ...
    /// </summary>
    public class XMLLoggerService : Microsoft.Extensions.Logging.ILoggerProvider
    {
        private bool disposedValue = false; // To detect redundant calls

        public XMLLoggerService(LogLevel logLevel, string outputPath, long rotateWhenRows)
        {
            LogLevel = logLevel;
