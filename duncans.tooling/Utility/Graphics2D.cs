// <copyright file="Graphics2D.cs" company="Duncan Saunders">
    ...
    public sealed class ImageManipulation
    {
        ...
        public Image Scale(ref Image inputImage, Size outputSize)
        {
            ...
            else
            {
                ...
                if (inputOrientation == duncans.ImageOrientation.square && outputOrientation == duncans.ImageOrientation.square)
                {
                ...
                else
                {
                    ...
                    scaleToMatchOutputHeight = (inputOrientation == duncans.ImageOrientation.landscape && outputOrientation == duncans.ImageOrientation.square)
                                                || (inputOrientation == duncans.ImageOrientation.square && outputOrientation == duncans.ImageOrientation.portrait)
                                                || (inputOrientation == duncans.ImageOrientation.landscape && outputOrientation == duncans.ImageOrientation.portrait)
                                                || ((inputOrientation == duncans.ImageOrientation.portrait && outputOrientation == duncans.ImageOrientation.portrait) && inputWHrelation >= outputWHrelation)
                                                || ((inputOrientation == duncans.ImageOrientation.landscape && outputOrientation == duncans.ImageOrientation.landscape) && inputWHrelation >= outputWHrelation);
        ...
        {
            ImageOrientation retVal = duncans.ImageOrientation.landscape;
            if (imageSize.Height > imageSize.Width)
            {
                retVal = duncans.ImageOrientation.portrait;
            }
            else if (imageSize.Height == imageSize.Width)
            {
                retVal = duncans.ImageOrientation.square;
            }
